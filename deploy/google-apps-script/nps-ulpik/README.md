...
```bash
GOOGLE_SHEETS_NPS_WEBAPP_URL=https://script.google.com/macros/s/AKfycbyjqz0pwRcUM7V1Seercw9oCJ2bC_7XmRaSzcQu8ecec5CODiFfBKSEv979b04L-Ofw/exec
...
Webhook activo: [verificar GET](https://script.google.com/macros/s/AKfycbyjqz0pwRcUM7V1Seercw9oCJ2bC_7XmRaSzcQu8ecec5CODiFfBKSEv979b04L-Ofw/exec) → `{"ok":true,"message":"Webhook NPS ULPIK activo"}`.

...
APPS_SCRIPT_URL="${GOOGLE_SHEETS_NPS_WEBAPP_URL:-https://script.google.com/macros/s/AKfycbx5kXSF9lLxcV2ucFGZMejRjVZj_BK0j_ELO-ey1bQlBxAKOONe6ZwHMm2fBxU2QKV7/exec}"
